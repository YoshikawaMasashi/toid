...
pub struct Generator {
    start_addrs_offset: u16,
    end_addrs_offset: u16,
    startloop_addrs_offset: u16,
    endloop_addrs_offset: u16,
    start_addrs_coarse_offset: u16,
    mod_lfo_to_pitch: f32,
    vib_lfo_to_pitch: f32,
    mod_env_to_pitch: f32,
    initial_filter_fc: f32,
    initial_filter_q: f32,
    mod_lfo_to_filter_fc: f32,
    mod_env_to_filter_fc: f32,
    end_addrs_coarse_offset: u16,
    mod_lfo_to_volume: f32,
    // unused1: Option<()>,
    chorus_effects_send: f32,
    reverb_effects_send: f32,
    pan: f32,
    // unused2: Option<()>,
    // unused3: Option<()>,
    // unused4: Option<()>,
    ...
    sustain_mod_env: f32,
    release_mod_env: f32,
    keynum_to_mod_env_hold: f32,
    keynum_to_mod_env_decay: f32,
    delay_vol_env: f32,
    attack_vol_env: f32,
    hold_vol_env: f32,
    decay_vol_env: f32,
    sustain_vol_env: f32,
    release_vol_env: f32,
    keynum_to_vol_env_hold: f32,
    keynum_to_vol_env_decay: f32,
    // instrument: Option<usize>,
    instrument: Option<Arc<Instrument>>,
    // reserved1: Option<()>,
    key_range: Range,
    vel_range: Range,
    startloop_addrs_coarse_offset: u16,
    keynum: Option<u8>,
    velocity: Option<u8>,
    initial_attenuation: f32,
    // reserved2: Option<()>,
    endloop_addrs_coarse_offset: u16,
    coarse_tune: f32,
    fine_tune: i16,
