...
fn main() {
    ...
    let mut portaudio_outputter = PortAudioOutputter::new(Arc::clone(&sound_state_manager));
    {
        ...
        reducer.reduce(MusicStateEvent::AddNewNoteOn(60.0 - 12.0, 0 * (44100 / 4)));
        reducer.reduce(MusicStateEvent::AddNewNoteOn(62.0 - 12.0, 1 * (44100 / 4)));
        reducer.reduce(MusicStateEvent::AddNewNoteOn(64.0 - 12.0, 2 * (44100 / 4)));
        reducer.reduce(MusicStateEvent::AddNewNoteOn(65.0 - 12.0, 3 * (44100 / 4)));
        reducer.reduce(MusicStateEvent::AddNewNoteOn(67.0 - 12.0, 4 * (44100 / 4)));
        reducer.reduce(MusicStateEvent::AddNewNoteOn(69.0 - 12.0, 6 * (44100 / 4)));
        reducer.reduce(MusicStateEvent::AddNewNoteOn(65.0 - 12.0, 7 * (44100 / 4)));
        reducer.reduce(MusicStateEvent::AddNewNoteOn(64.0 - 12.0, 8 * (44100 / 4)));
        reducer.reduce(MusicStateEvent::AddNewNoteOff(9 * (44100 / 4)));
        reducer.reduce(MusicStateEvent::AddNewNoteOn(62.0 - 12.0, 10 * (44100 / 4)));
        reducer.reduce(MusicStateEvent::AddNewNoteOff(11 * (44100 / 4)));
        reducer.reduce(MusicStateEvent::AddNewNoteOn(60.0 - 12.0, 12 * (44100 / 4)));
    }
