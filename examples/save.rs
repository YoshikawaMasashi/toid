...
use toid::outputters::wave_file_outputter::WaveFileOutputter;
...
fn main() {
    ...
    let mut wave_file_outputter = WaveFileOutputter::new(Arc::clone(&player)
        as Arc<
            dyn Player<
                MusicState,
                MusicStateEvent,
    ...
    wave_file_outputter.save("toid.wav".to_string(), 12.0);
}
